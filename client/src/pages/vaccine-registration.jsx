  ...
  RegistrationForm(disabled = false) {
    return (
      <div className="registration-form" style={{ marginTop: "12px" }}>
        ...
        <div className="mb-3 row">
          <label htmlFor="aadharNo" className="col-sm-2 col-form-label">
            Aadhar No
          </label>
          <div className="col-sm-10">
            <input
              ref={(node) => (this.inputAadhar = node)}
              readOnly={disabled}
              type="number"
              className="form-control"
              id="aadharNo"
        ...
        <div className="mb-3 row">
          <label htmlFor="inputComplicacy" className="col-sm-2 col-form-label">
            Complicacy
          </label>
          <div className="col-sm-10">
            <select
              ref={(node) => (this.inputComplicacy = node)}
  ...
  render() {
    return (
      <div>
        <div
          style={{
            backgroundImage: `url(${"/img/reg.jpg"})`,
            height: "500px",
            width: "100%",
            ...
            <div className="row">
              <div className="col-12">
                {this.state.registered && (
                  <Alert message="User already registered" />
                )}
